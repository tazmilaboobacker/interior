...
const Footer = () => {
  return (
    <motion.footer
      ...
      whileInView="animate"
    >
      <div className="container py-11 bg-gray-500 text-white">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 font-semibold">
            ...
            <p>Coimbatore ditrict,TamilNadu</p>
          ...
          <div className="space-y-4">
            ...
            <ul className="text-base font-semibold space-y-4">
              <li className="flex items-center space-x-3">
                <FaPhone />
                <a href="#">+91 8760203390</a>
              </li>
              <li className="flex items-center space-x-3">
                <LuMessageSquare />
                <a href="mailto:contact.tazmiltrendzle01@gmail.com">Email</a>
              </li>
            </ul>
          </div>
        </div>
