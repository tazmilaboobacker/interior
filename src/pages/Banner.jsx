...
const backgroundColor = "#f8f9fa"; // Light gray background for contrast
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
            <motion.h1
              ...
              initial="initial"
              whileInView="animate"
              className="text-4xl font-bold font-serif text-black" // Change to black for contrast
            >
            ...
            <motion.p
              ...
              initial="initial"
              whileInView="animate"
              className="text-gray-700 text-sm leading-7" // Darker gray for better readability
            >
            ...
            <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px]">
              ...
              >
                <div className="max-w-[80px] space-y-2">
                  <p className="text-3xl font-bold font-serif text-black">15</p>
                  <p className="text-gray-700 text-sm">Years of Experience</p>
                </div>
                <div className="max-w-[80px] space-y-2">
                  <p className="text-3xl font-bold font-serif text-black">350</p>
                  <p className="text-gray-700 text-sm">Happy Clients</p>
                </div>
                <div className="max-w-[80px] space-y-2">
                  <p className="text-3xl font-bold font-serif text-black">34</p>
                  <p className="text-gray-700 text-sm">Award Gained</p>
                </div>
              </motion.div>
              <div>
                <motion.button
